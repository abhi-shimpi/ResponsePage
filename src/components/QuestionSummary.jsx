      ...
      <Box className={classes.questionSummaryContainer}>
        ...
        <Box className={classes.questionsContainer}>
          ...
          <Box className={classes.singleQuestion} >
            ...
            <Typography p={2} bgcolor={"#F7F7F7"} variant="caption" color="initial">{data.question}</Typography>
            <Box className={classes.responseChart}>

              <BarChart display={"inline-block"} width={500} height={300} data={data.data} layout="vertical">
